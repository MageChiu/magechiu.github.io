...
> 特征值计算的数学模型如下：
>
> $\backslash vec\ \backslash lambda\_ c\  = \ \backslash text\lbrack U\_ c(t)\rbrack,\ t\ \backslash in\ \lbrack 0,24)$
>
> 其中，${\overrightarrow{\lambda}}_{c}$表示容器c的特征值，$U_{c}(t)$表示容器c在t时刻的资源利用率。
>
> 对于机器上的特征值总和，计算公式为：
>
> $S\  = \ \backslash sum\_\{ c\ \backslash in\ \backslash text\{ Host\}\}\ \backslash vec\ \backslash lambda\_ c$
>
...
$Peak\_ c\  = \ \backslash text\{ Max\}(U\_ c)$

$Reclaim\_\{ stable\}\  = \ \backslash sum\_\{ c\ \backslash in\ Container\_\{ stable\}\}\ (Q\_ c\  - \ Peak\_ c),\ \backslash text\{\ where\ \}\ Peak\_ c\  = \ \backslash text\{ Max\}(U\_ c)$
